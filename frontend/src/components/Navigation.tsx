...
export default function Navigation({ onHomeClick, showHome = false, onPricingClick }: NavigationProps) {
  ...
  const handlePricingClick = () => {
    if (onPricingClick) {
      ...
      // Default behavior: show pricing modal
      alert('Pricing Information:\n\nResearch Costs:\n- Quick Lookup (LITE): $0.005 per query\n- Standard Research (BASE): $0.02 per query\n- Deep Analysis (PRO): $0.10 per query\n- Comprehensive (ULTRA): $0.30 per query\n\nTimeline Features:\n- Save Only: FREE\n- Lite Check: ~$0.005\n- Refactor with Research: ~$0.15\n\nSee CLAUDE.md for full pricing details.');
    }
  };
